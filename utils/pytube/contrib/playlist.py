...
from utils.pytube import extract, YouTube
from utils.pytube import request
from utils.pytube.helpers import cache, DeferredGeneratorList, install_proxy, uniqueify
...
class Playlist(Sequence):
    ...
    def sidebar_info(self):
        ...
        if self._sidebar_info:
            ...
            self._sidebar_info = self.initial_data['sidebar']['playlistSidebarRenderer']['items']
            return self._sidebar_info
